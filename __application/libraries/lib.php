...
class lib {
	...
	function fillcombo($type="", $balikan="", $p1="", $p2="", $p3=""){
		...
		$optTemp = '<option value="null"> -- Choose -- </option>';
		switch($type){
			...
			case "sitetype":
				$data = array(
					'0' => array('id'=>'-','txt'=>'-'),
					'1' => array('id'=>'Greenfield','txt'=>'Greenfield'),
					'2' => array('id'=>'Rooftop','txt'=>'Rooftop'),
					'3' => array('id'=>'IBS','txt'=>'IBS'),
					'4' => array('id'=>'Mobile BTS','txt'=>'Mobile BTS'),
					'5' => array('id'=>'Minaret/Mosque Tower','txt'=>'Minaret/Mosque Tower'),
					'6' => array('id'=>'Camouflage/Billboard','txt'=>'Camouflage/Billboard'),
					'7' => array('id'=>'add','txt'=>'add'),
				);
			break;
			case "sitetype":
				$data = array(
					'0' => array('id'=>'-','txt'=>'-'),
					'1' => array('id'=>'SST 4 LEG','txt'=>'SST 4 LEG'),
					'2' => array('id'=>'SST 3 LEG','txt'=>'SST 3 LEG'),
					'3' => array('id'=>'Monopole','txt'=>'Monopole'),
					'4' => array('id'=>'Pole (1)','txt'=>'Pole (1)'),
					'5' => array('id'=>'Pole (2)','txt'=>'Pole (2)'),
					'6' => array('id'=>'Pole (3)','txt'=>'Pole (3)'),
					'7' => array('id'=>'Guyed MAST','txt'=>'Guyed MAST'),
					'8' => array('id'=>'Minaret/Tower Masjid','txt'=>'Minaret/Tower Masjid'),
					'9' => array('id'=>'Billboard/Camouflage','txt'=>'Billboard/Camouflage'),
					'10' => array('id'=>'DAS','txt'=>'DAS'),
				);
			break;
			default:
